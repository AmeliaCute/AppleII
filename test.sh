...
nasm "sources/bootloader.asm" -f bin -o "bin/boot.bin"
nasm "sources/kernel_entry.asm" -f elf -o "bin/kernel_entry.o"
i386-elf-gcc -ffreestanding -m32 -no-pie -g -c "sources/kernel.cpp" -o "bin/kernel.o"
nasm "sources/emulfix.asm" -f bin -o "bin/zeroes.bin"
